                ...
                <div class="px-4 pb-4 rounded">
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full lg:w-1/2 px-2 py-3">
                            ...
                            <InputText v-model="useValue.user.fullName" class="w-full" placeholder="" />
                        </div>
                        <div class="w-full lg:w-1/2 px-2 py-3">
                            <label for="Phone" class="text-gray-700">{{ $t('pnum') }}</label>
                            <InputText v-model="useValue.user.phoneNumber" class="w-full" placeholder="+0909436072" />
                        </div>
                        <div class="w-full px-2 py-3">
                            <label for="Email" class="text-gray-700">Email</label>
                            <InputText v-model="useValue.user.email" class="w-full" placeholder="example@gmail.com" />
                        </div>
                        <div class="w-full px-2 py-3">
            ...
            <div class=" mb-0">
                <div class="px-4 py-2 justify-items-center mt-2 mb-2">
                    ...
                    <button class="btn-color-medium text-white font-semibold py-2 rounded w-full mt-6"
                        type="submit" @click="goToCheckout">
                        Mua Hàng
                    </button>
                </div>
...
async function goToCheckout() {
    try {
      const redirectUrl = await paymentService.processPayment(getCart.value);
